...
public class TranslationService {
    ...
    private String translate(String text, String sourceLang, String targetLang) {
        ...
        TraceStore.put("translation.source", SafeRedactor.traceLabelOrFallback(sourceLang, "unknown"));
        TraceStore.put("translation.target", SafeRedactor.traceLabelOrFallback(targetLang, "unknown"));
        TraceStore.put("translation.ragBound", "true");
    ...
    private String callV2Translate(String text, String sourceLang, String targetLang) {
        ...
        if (apiKey == null || apiKey.isBlank()) {
            TraceStore.put("translation.disabled", true);
            TraceStore.put("translation.disabledReason", "api-key-missing");
            return text;
        }
        ...
        try {
            ...
            TraceStore.put("translation.failReason", ex.getClass().getSimpleName());
            return text;
        }
        ...
        try {
            ...
            if (translated == null || translated.isBlank()) {
                TraceStore.put("translation.failReason", "blank-response");
                return text;
            }
            return translated;
        } catch (Exception e) {
            TraceStore.put("translation.failReason", e.getClass().getSimpleName());
            return text;
        }
    }
