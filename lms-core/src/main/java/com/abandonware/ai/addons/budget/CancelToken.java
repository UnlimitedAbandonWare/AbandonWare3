 ...
 * 클래스: CancelToken
 * 역할(Role): Class
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/addons/budget/CancelToken.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.addons.budget.CancelToken
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: uses concurrent primitives.
// /
/* agent-hint:
id: com.abandonware.ai.addons.budget.CancelToken
role: config
*/
class CancelToken {
