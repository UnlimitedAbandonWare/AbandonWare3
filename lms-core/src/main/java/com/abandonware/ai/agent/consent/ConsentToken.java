 ...
 * from the {@link ConsentService}.  This /**
 * [GPT-PRO-AGENT v2] - concise navigation header (no runtime effect).
 * Module: com.abandonware.ai.agent.consent.ConsentToken
 * Role: config
 * Observability: propagates trace headers if present.
 * Thread-Safety: appears stateless.
 */
/* agent-hint:
id: com.abandonware.ai.agent.consent.ConsentToken
role: config
*/
// class intentionally exposes only
 ...
 * 클래스: ConsentToken
 * 역할(Role): Class
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/agent/consent/ConsentToken.java
 *
 * 연결 포인트(Hooks):
