// Root aggregator build (Kotlin DSL)
plugins {}
...
tasks.register("preflight") {
    doLast {
        ...
        val hasFindbugsAnn = c.getByName("compileOnly").dependencies.any { it.group == "com.google.code.findbugs" && it.name == "annotations" }
        if (!hasLombok || !(hasSpotbugsAnn || hasFindbugsAnn)) {
