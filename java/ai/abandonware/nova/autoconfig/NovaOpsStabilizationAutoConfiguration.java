...
public class NovaOpsStabilizationAutoConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(name = "nova.orch.web.failsoft.ratelimit-backoff.enabled", havingValue = "true", matchIfMissing = true)
    public ProviderRateLimitBackoffAspect providerRateLimitBackoffAspect(RateLimitBackoffCoordinator backoffCoordinator) {
        return new ProviderRateLimitBackoffAspect(backoffCoordinator);
    }
}
